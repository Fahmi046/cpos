<div class="mt-6 bg-white rounded-md shadow-md overflow-x-auto">
    <h2 class="text-lg font-semibold text-gray-800 mb-4 px-4">📦 Kategori Obat</h2>
    ...
    <table class="w-full text-sm text-left border-collapse">
        ...
        <tbody>
            @forelse ($kategoriObat as $kategori)
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-4 py-3 text-center">
                        <span
                            ...
                            {{ $kategori->aktif ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }}">
                            {{ $kategori->aktif ? 'Ya' : 'Tidak' }}
                        </span>
                    </td>

                    <!-- Aksi -->
                    <td class="px-4 py-3 flex justify-center space-x-2">
                        <button wire:click="$dispatch('edit-kategori', { id: {{ $kategori->id }} })"
            ...
            @empty
                <tr>
                    <td colspan="5" class="text-center py-4 text-gray-500">Belum ada kategori obat</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="mt-6 mb-4 flex justify-center">
        {{ $kategoriObat->links('vendor.pagination.custom') }}
    </div>
</div>
